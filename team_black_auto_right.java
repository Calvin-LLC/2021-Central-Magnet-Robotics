...
@TeleOp(name = "Team Black Robnot Autonomous Right", group = "best_opmode")
public class BlackAutonomous2<motor> extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            acc_sleep(7000);
            duck_wheel.setPower(-.31);
            acc_sleep(7000);
            duck_wheel.setPower(-.36);
            acc_sleep(7000);
